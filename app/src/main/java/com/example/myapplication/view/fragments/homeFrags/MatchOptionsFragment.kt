...
class MatchOptionsFragment : Fragment() {
    ...
    var data:com.example.myapplication.model.data.basketball.homepage.Match?=null
    ...
    private fun returnTime(dataObject: com.example.myapplication.model.data.basketball.homepage.Match): String {
        val sdf = SimpleDateFormat("yyyy/M/dd HH:mm:ss")
        val time = returnGMTToCurrentTimezone(returnGMTTimeInMs(dataObject.matchTime))
        return sdf.format(time)
    }
    ...
    fun returnState(data: com.example.myapplication.model.data.basketball.homepage.Match):String {
        val sdf= SimpleDateFormat("yyyy/M/dd HH:mm:ss")
        val sdf2= SimpleDateFormat("EEE, dd MMM")
