...
class NewsAdapter (var context: Context,var  newsList:ArrayList<com.example.myapplication.model.data.news.List>,var loadMoreCommunicator:LoadMoreCommunicator, var onclick: RecyclerViewOnclick):RecyclerView.Adapter<NewsAdapter.viewHolder>(){
    ...
    fun updateList(list:List<com.example.myapplication.model.data.news.List>){
