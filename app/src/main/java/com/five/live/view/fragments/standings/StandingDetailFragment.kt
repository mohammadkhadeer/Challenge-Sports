...
import com.five.live.model.data.standings.TeamInfo
import com.five.live.model.data.standings.TotalStanding
import com.five.live.model.data.standings.player.List
...
import com.five.live.view.fragments.homeFrags.adapter.adapterOfAdapter.MotherRecyclerViewAdapter
import com.five.live.view.fragments.standings.adapter.PlayerStandingAdapter
import com.five.live.view.fragments.standings.adapter.RankingsAdapter
import com.five.live.view.fragments.standings.adapter.RankingsAdapterDetail
...
class StandingDetailFragment : Fragment() {
    ...
    private fun populateRecyclerView(rv: RecyclerView, data: LeagueStanding) {
        ...
        Glide.with(requireContext())
            .load(data.leagueInfo.logo)
            .into(loadinto!!)
        val rankings = data.totalStandings as ArrayList<com.five.live.model.data.homepage.leagueInfo.TotalStanding>
        rv.adapter = RankingsAdapterDetail(
            requireContext(), data.teamInfo as ArrayList<com.five.live.model.data.homepage.leagueInfo.TeamInfo>,
            rankings
        )
        rv.layoutManager =
            LinearLayoutManager(requireContext(), LinearLayoutManager.VERTICAL, false)
