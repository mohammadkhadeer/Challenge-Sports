...
import com.score.pro.view.fragments.homeFrags.detailFragment.LeagueInfoFragment
import com.score.pro.view.fragments.standings.StandingDetailFragment
...
class LeagueBaseFragmet : Fragment() {
    ...
    private var bbMatch: com.score.pro.model.data.basketball.homepage.Match? = null
    ...
    fun setData(match: com.score.pro.model.data.basketball.homepage.Match) {
        this.bbMatch = match
    }
