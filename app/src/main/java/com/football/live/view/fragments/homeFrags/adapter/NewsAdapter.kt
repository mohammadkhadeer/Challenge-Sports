...
class NewsAdapter (var context: Context, var  newsList:ArrayList<com.football.live.model.data.news.List>, var loadMoreCommunicator:LoadMoreCommunicator, var onclick: RecyclerViewOnclick):RecyclerView.Adapter<NewsAdapter.viewHolder>(){
    ...
    fun updateList(list:List<com.football.live.model.data.news.List>){
