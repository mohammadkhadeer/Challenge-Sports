package com.football.live.view.fragments.homeFrags
...
import score.pro.R
import com.football.live.model.data.homepage.new2.Match
import com.football.live.utils.GeneralTools
import com.football.live.view.fragments.homeFrags.adapter.MainAdapter
import com.football.live.view.fragments.homeFrags.adapter.MainAdapterCommunicator
import com.football.live.view.fragments.homeFrags.detailFragment.AnalysisFragment
import com.football.live.view.fragments.homeFrags.detailFragment.EventFragment
...
class MatchOptionsFragment : Fragment() {
    ...
    var data:com.football.live.model.data.basketball.homepage.Match?=null
    ...
    private fun returnTime(dataObject: com.football.live.model.data.basketball.homepage.Match): String {
        val sdf = SimpleDateFormat("yyyy/M/dd HH:mm:ss")
        val time = returnGMTToCurrentTimezone(returnGMTTimeInMs(dataObject.matchTime))
        return sdf.format(time)
    }
    ...
    fun returnState(data: com.football.live.model.data.basketball.homepage.Match):String {
        val sdf= SimpleDateFormat("yyyy/M/dd HH:mm:ss")
        val sdf2= SimpleDateFormat("EEE, dd MMM")
