package com.example.myapplication.view.floatingbubble.service
...
import com.example.myapplication.model.data.livescorepin.Match
import com.example.myapplication.utils.Formatters
import com.example.myapplication.utils.SharedPreference
import com.example.myapplication.view.fragments.homeFrags.adapter.EventsAdapter
import com.example.myapplication.view.fragments.homeFrags.adapter.MainAdapter
import com.example.myapplication.view.fragments.homeFrags.adapter.TechnicAdapter
...
class FloatingScoreService:FloatingBubbleService() {
    ...
    fun populateMatch(view:View,match:com.example.myapplication.model.data.livescorepin.Match){
        try {
