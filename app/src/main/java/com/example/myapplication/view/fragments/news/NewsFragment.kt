...
import com.example.myapplication.view.fragments.video.VideoBaseFragment
import com.example.myapplication.view.fragments.video.VideosDetailFragment
...
class NewsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
       ...
       val viewpager= view.findViewById<ViewPager2>(R.id.fragment_viewpager)
        ...
        tabsTitles.add("News Articles")
        tabsTitles.add("Video Clips")
