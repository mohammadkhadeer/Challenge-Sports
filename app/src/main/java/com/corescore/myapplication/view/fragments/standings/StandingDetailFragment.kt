...
import com.corescore.myapplication.model.data.homepage.leagueInfo.LeagueStanding
import com.corescore.myapplication.model.data.homepage.leagueInfo.any.LeagueStandingTypeGroupBase
...
import com.corescore.myapplication.model.data.standings.TotalStanding
import com.corescore.myapplication.model.data.standings.player.List
...
import com.corescore.myapplication.view.fragments.homeFrags.adapter.adapterOfAdapter.MotherRecyclerViewAdapter
import com.corescore.myapplication.view.fragments.standings.adapter.PlayerStandingAdapter
import com.corescore.myapplication.view.fragments.standings.adapter.RankingsAdapter
import com.corescore.myapplication.view.fragments.standings.adapter.RankingsAdapterDetail
...
class StandingDetailFragment : Fragment() {
    ...
    private fun populateRecyclerView(rv: RecyclerView, data: LeagueStanding) {
        ...
        Glide.with(requireContext())
            .load(data.leagueInfo.logo)
            .into(loadinto!!)
        val rankings = data.totalStandings as ArrayList<com.corescore.myapplication.model.data.homepage.leagueInfo.TotalStanding>
        rv.adapter = RankingsAdapterDetail(
            requireContext(), data.teamInfo as ArrayList<com.corescore.myapplication.model.data.homepage.leagueInfo.TeamInfo>,
            rankings
        )
        rv.layoutManager =
            LinearLayoutManager(requireContext(), LinearLayoutManager.VERTICAL, false)
