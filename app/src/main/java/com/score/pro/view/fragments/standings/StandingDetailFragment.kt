package com.score.pro.view.fragments.standings
...
import com.score.pro.model.data.standings.TotalStanding
import com.score.pro.model.data.standings.player.List
...
import com.score.pro.view.fragments.homeFrags.adapter.adapterOfAdapter.MotherRecyclerViewAdapter
import com.score.pro.view.fragments.standings.adapter.PlayerStandingAdapter
import com.score.pro.view.fragments.standings.adapter.RankingsAdapter
import com.score.pro.view.fragments.standings.adapter.RankingsAdapterDetail
...
class StandingDetailFragment : Fragment() {
    ...
    private fun populateRecyclerView(rv: RecyclerView, data: LeagueStanding) {
        ...
        Glide.with(requireContext())
            .load(data.leagueInfo.logo)
            .into(loadinto!!)
        val rankings = data.totalStandings as ArrayList<com.score.pro.model.data.homepage.leagueInfo.TotalStanding>
        rv.adapter = RankingsAdapterDetail(
            requireContext(), data.teamInfo as ArrayList<com.score.pro.model.data.homepage.leagueInfo.TeamInfo>,
            rankings
        )
        rv.layoutManager =
            LinearLayoutManager(requireContext(), LinearLayoutManager.VERTICAL, false)
