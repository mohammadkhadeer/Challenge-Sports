...
import com.score.pro.view.fragments.homeFrags.detailFragment.AnalysisFragment
import com.score.pro.view.fragments.homeFrags.detailFragment.EventFragment
...
class MatchOptionsFragment : Fragment() {
    ...
    var data:com.score.pro.model.data.basketball.homepage.Match?=null
    ...
    private fun returnTime(dataObject: com.score.pro.model.data.basketball.homepage.Match): String {
        val sdf = SimpleDateFormat("yyyy/M/dd HH:mm:ss")
        val time = returnGMTToCurrentTimezone(returnGMTTimeInMs(dataObject.matchTime))
        return sdf.format(time)
    }
    ...
    fun returnState(data: com.score.pro.model.data.basketball.homepage.Match):String {
        val sdf= SimpleDateFormat("yyyy/M/dd HH:mm:ss")
        val sdf2= SimpleDateFormat("EEE, dd MMM")
