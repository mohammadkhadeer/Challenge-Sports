package com.corescore.myapplication.view.fragments.standings.adapter
...
import com.corescore.myapplication.model.data.homepage.leagueInfo.TeamInfo
import com.corescore.myapplication.model.data.homepage.leagueInfo.TotalStanding
...
class RankingsAdapterDetail(var context:Context, var teams:ArrayList<TeamInfo>, var rankings:ArrayList<TotalStanding>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        try {
            ...
            val name=when(GeneralTools.getLocale(context)){
