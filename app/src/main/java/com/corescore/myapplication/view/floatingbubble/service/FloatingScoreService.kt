package com.corescore.myapplication.view.floatingbubble.service
...
import com.corescore.myapplication.model.data.livescorepin.Match
...
class FloatingScoreService:FloatingBubbleService() {
    ...
    fun populateMatch(view:View,match:com.corescore.myapplication.model.data.livescorepin.Match){
        try {
