...
class NewsAdapter_Horizontal (var context: Context, var  newsList:ArrayList<com.football.live.model.data.news.List>, var onclick: RecyclerViewOnclick):RecyclerView.Adapter<NewsAdapter_Horizontal.viewHolder>(){
