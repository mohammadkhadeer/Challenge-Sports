package com.football.live.view.floatingbubble.service
...
import com.football.live.model.data.livescorepin.Match
import com.football.live.utils.Formatters
import com.football.live.utils.SharedPreference
import com.football.live.view.fragments.homeFrags.adapter.EventsAdapter
import com.football.live.view.fragments.homeFrags.adapter.MainAdapter
import com.football.live.view.fragments.homeFrags.adapter.TechnicAdapter
...
class FloatingScoreService:FloatingBubbleService() {
    ...
    fun populateMatch(view:View,match:com.football.live.model.data.livescorepin.Match){
        try {
