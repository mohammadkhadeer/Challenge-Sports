...
class NewsAdapter (var context: Context, var  newsList:ArrayList<com.challenge.sports.model.data.news.List>, var loadMoreCommunicator:LoadMoreCommunicator, var onclick: RecyclerViewOnclick):RecyclerView.Adapter<NewsAdapter.viewHolder>(){
