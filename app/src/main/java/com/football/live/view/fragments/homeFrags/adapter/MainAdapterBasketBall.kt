...
import score.pro.R
import com.football.live.model.data.basketball.homepage.Match
...
//            }
    ...
    private fun returnMinutes(dataObject: com.football.live.model.data.homepage.new2.Match): String {
