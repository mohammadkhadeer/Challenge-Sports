...
import com.football.live.view.fragments.homeFrags.detailFragment.LeagueInfoFragment
import com.football.live.view.fragments.standings.StandingDetailFragment
...
class LeagueBaseFragmet : Fragment() {
    ...
    private var bbMatch: com.football.live.model.data.basketball.homepage.Match? = null
    ...
    fun setData(match: com.football.live.model.data.basketball.homepage.Match) {
        this.bbMatch = match
    }
