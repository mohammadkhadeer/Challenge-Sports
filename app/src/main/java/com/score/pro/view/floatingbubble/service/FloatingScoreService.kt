package com.score.pro.view.floatingbubble.service
...
import com.score.pro.model.data.livescorepin.Match
import com.score.pro.utils.Formatters
import com.score.pro.utils.SharedPreference
import com.score.pro.view.fragments.homeFrags.adapter.EventsAdapter
import com.score.pro.view.fragments.homeFrags.adapter.MainAdapter
import com.score.pro.view.fragments.homeFrags.adapter.TechnicAdapter
...
class FloatingScoreService:FloatingBubbleService() {
    ...
    fun populateMatch(view:View,match:com.score.pro.model.data.livescorepin.Match){
        try {
