...
import com.five.live.view.fragments.homeFrags.detailFragment.LeagueInfoFragment
import com.five.live.view.fragments.standings.StandingDetailFragment
...
class LeagueBaseFragmet : Fragment() {
    ...
    private var bbMatch: com.five.live.model.data.basketball.homepage.Match? = null
    ...
    fun setData(match: com.five.live.model.data.basketball.homepage.Match) {
        this.bbMatch = match
    }
